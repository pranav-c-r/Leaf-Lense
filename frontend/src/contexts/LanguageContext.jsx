...
const translations = {
  ...
  ml: {
    ...
    // Price Prediction
    pricePredictionTitle: 'വിള വില പ്രവചനം',
    currentMarketPrice: 'നിലവിലെ വിപണി വില',
    predictedPrice: 'പ്രവചിക്കുന്ന വില',
    priceChange: 'വില മാറ്റം',
    marketTrends: 'വിപണി പ്രവണതകൾ',
    demandForecast: 'ആവശ്യം പ്രവചനം',
    supplyAnalysis: 'വിതരണ വിശകലനം',
    bestSellingTime: 'വിൽക്കാനുള്ള ഏറ്റവും നല്ല സമയം',
    nearbyMarkets: 'സമീപത്തുള്ള വിപണികൾ',
    priceHistory: 'വില ചരിത്രം',
    
    // Fertilizer
    fertilizerRecommendation: 'വള ശുപാർശ',
    soilAnalysis: 'മണ്ണ് വിശകലനം',
    nutrientLevels: 'പോഷക ലെവലുകൾ',
    nitrogen: 'നൈട്രജൻ (N)',
    phosphorus: 'ഫോസ്ഫറസ് (P)',
    potassium: 'പൊടാഷ് (K)',
    recommendedFertilizer: 'ശുപാർശിക്കുന്ന വളം',
    applicationRate: 'അപ്ലിക്കേഷൻ നിരക്ക്',
    applicationTiming: 'അപ്ലിക്കേഷൻ സമയം',
    costEstimate: 'ചെലവ് കണക്കാക്കി',
    
    // AI Insights
    aiInsightsTitle: 'AI ഇൻസൈറ്റ്സ്',
    smartAnalytics: 'സ്മാർട്ട് വിശകലനം',
    performanceMetrics: 'പ്രകടന മെട്രിക്സ്',
    optimization: 'ഒപ്റ്റിമൈസേഷൻ നിർദ്ദേശങ്ങൾ',
    riskAssessment: 'റിസ്ക് അസസ്മെന്റ്',
    sustainabilityScore: 'സുസ്ഥിരത സ്കോർ',
    carbonFootprint: 'കാർബൺ ഫുട്പ്രിന്റ്',
    waterUsage: 'ജല ഉപയോഗ കാര്യക്ഷമത',
    
    // Profile
    userProfile: 'ഉപയോക്താവിന്റെ പ്രോഫൈൽ',
    personalInformation: 'വ്യക്തിഗത വിവരങ്ങൾ',
    farmDetails: 'കൃഷിഭൂമി വിവരങ്ങൾ',
    ...
    // Landing Page
    smartFarmingWithAI: 'കൃത്രിമ ബുദ്ധിയുമായുള്ള സ്മാർട്ട് കൃഷി',
    artificialIntelligence: 'കൃത്രിമ ബുദ്ധി',
    transformAgriculturalOperations: 'AI-പവേഡ് ഇൻസൈറ്റുകളുമായി നിങ്ങളുടെ കാർഷിക പ്രവർത്തനങ്ങൾ രൂപാന്തരപ്പെടുത്തുക. വിളവ് പ്രവചിക്കുക, രോഗങ്ങൾ കണ്ടെത്തുക, വളപ്രയോഗം ഒപ്റ്റിമൈസ് ചെയ്യുക, അധികാരിക മെഷീൻ ലേണിംഗ് സാങ്കേതികവിദ്യയുമായി നിങ്ങളുടെ വിളവെടുപ്പ് പരമാവധി ഉയർത്തുക.',
    startFreeTrial: 'സൗജന്യ ട്രയൽ ആരംഭിക്കുക',
    watchDemo: 'ഡെമോ കാണുക',
    poweredByAdvancedAI: 'അധികാരിക AI-പവേഡ്',
    activeFarmers: 'സക്രിയ കർഷകർ',
    predictionsMade: 'പ്രവചനങ്ങൾ നടത്തി',
    accuracyRate: 'കൃത്യത നിരക്ക്',
    countriesServed: 'രാജ്യങ്ങളിൽ സേവനം',
    revolutionaryAIFeatures: 'വിപ്ലവകരമായ AI സവിശേഷതകൾ',
    harnessPowerOfAI: 'കൃത്രിമ ബുദ്ധിയുടെ ശക്തി പ്രയോജനപ്പെടുത്തി ഡാറ്റ-ഡ്രൈവൻ കൃഷി തീരുമാനങ്ങൾ എടുക്കുക, മുമ്പൊരിക്കലും ഇല്ലാത്ത രീതിയിൽ നിങ്ങളുടെ കാർഷിക പ്രവർത്തനങ്ങൾ ഒപ്റ്റിമൈസ് ചെയ്യുക.',
    whyChooseLeafLense: 'എന്തുകൊണ്ട് ലീഫ് ലെൻസ് തിരഞ്ഞെടുക്കണം?',
    joinThousandsOfFarmers: 'ഞങ്ങളുടെ AI-പവേഡ് പ്ലാറ്റ്ഫോം ഉപയോഗിച്ച് അവരുടെ പ്രവർത്തനങ്ങൾ രൂപാന്തരപ്പെടുത്തിയ ആയിരക്കണക്കിന് കർഷകരോടൊപ്പം ചേരുക. ആദ്യ ദിവസം മുതൽ യഥാർത്ഥ ഫലങ്ങൾ കാണുക.',
    increaseCropYields: 'വിള വിളവ് 30% വരെ വർദ്ധിപ്പിക്കുക',
    reduceFertilizerCosts: 'വള ചെലവ് 25% കുറയ്ക്കുക',
    earlyDiseaseDetection: 'ആദ്യകാല രോഗ കണ്ടെത്തൽ 90% ബാധിത വിളകൾ രക്ഷിക്കുന്നു',
    realTimeMonitoring: 'റിയൽ-ടൈം കാലാവസ്ഥ, മണ്ണ് മോണിറ്ററിംഗ്',
    sustainableFarming: 'സുസ്ഥിര കൃഷി പ്രയോഗങ്ങൾ മാർഗദർശനം',
    expertAIAssistance: '24/7 വിദഗ്ധ AI സഹായം',
    averageResults: 'ശരാശരി ഫലങ്ങൾ',
    withinSixMonths: 'ഞങ്ങളുടെ പ്ലാറ്റ്ഫോം ഉപയോഗിച്ച് 6 മാസത്തിനുള്ളിൽ',
    yieldIncrease: 'വിളവ് വർദ്ധന',
    costReduction: 'ചെലവ് കുറവ്',
    diseasePrevention: 'രോഗ നിരോധനം',
    trustedByFarmers: 'ലോകമെമ്പാടുമുള്ള കർഷകർ വിശ്വസിക്കുന്നു',
    dontTakeOurWord: 'ഞങ്ങളുടെ വാക്ക് മാത്രം വിശ്വസിക്കരുത്. ഞങ്ങളുടെ കർഷക കമ്മ്യൂണിറ്റി അവരുടെ അനുഭവത്തെക്കുറിച്ച് എന്താണ് പറയുന്നതെന്ന് ഇവിടെ കാണുക.',
    readyToTransform: 'നിങ്ങളുടെ കൃഷി രൂപാന്തരപ്പെടുത്താൻ തയ്യാറാണോ?',
    joinOverFarmers: '50,000-ലധികം കർഷകരോടൊപ്പം ചേരുക, അവർ ഇതിനകം AI ഉപയോഗിച്ച് അവരുടെ പ്രവർത്തനങ്ങൾ ഒപ്റ്റിമൈസ് ചെയ്യുന്നു. ഇന്ന് നിങ്ങളുടെ സൗജന്യ ട്രയൽ ആരംഭിക്കുക, AI ഉണ്ടാക്കാൻ കഴിയുന്ന വ്യത്യാസം കാണുക.',
    noCreditCardRequired: 'ക്രെഡിറ്റ് കാർഡ് ആവശ്യമില്ല',
    allRightsReserved: '2025 ലീഫ് ലെൻസ്. എല്ലാ അവകാശങ്ങളും നിക്ഷിപ്തം.',
    
    // Farm & Crop Details
    farmCropDetails: 'കൃഷിഭൂമി & വിള വിവരങ്ങൾ',
    state: 'സംസ്ഥാനം',
    selectState: 'സംസ്ഥാനം തിരഞ്ഞെടുക്കുക',
    district: 'ജില്ല',
    selectDistrict: 'ജില്ല തിരഞ്ഞെടുക്കുക',
    area: 'പ്രദേശം',
    areaHectares: 'പ്രദേശം (ഹെക്ടർ)',
    soilPh: 'മണ്ണ് pH',
    cropYear: 'വിള വർഷം',
    selectYear: 'വർഷം തിരഞ്ഞെടുക്കുക',
    season: 'ഋതു',
    selectSeason: 'ഋതു തിരഞ്ഞെടുക്കുക',
    soilNutrients: 'മണ്ണ് പോഷകങ്ങൾ (കിലോഗ്രാം/ഹെക്ടർ)',
    weatherConditions: 'കാലാവസ്ഥാ അവസ്ഥകൾ',
    temperature: 'താപനില (°C)',
    humidity: 'ആർദ്രത (%)',
    rainfall: 'മഴ (മി.മീ.)',
    analyzing: 'വിശകലനം ചെയ്യുന്നു...',
    predictYield: 'വിളവ് പ്രവചിക്കുക',
    predictedYield: 'പ്രവചിക്കുന്ന വിളവ്',
    tonsPerHectare: 'ടൺ/ഹെക്ടർ',
    totalYieldTons: 'മൊത്തം വിളവ് (ടൺ)',
    readyToPredict: 'പ്രവചിക്കാൻ തയ്യാറാണ്',
    fillFormToGetPredictions: 'നിങ്ങളുടെ വിളകൾക്കായി AI-പവേഡ് വിളവ് പ്രവചനങ്ങൾ ലഭിക്കാൻ ഫോം പൂരിപ്പിക്കുക.',
